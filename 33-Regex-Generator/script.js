document.addEventListener('DOMContentLoaded', () => {
    ...
    generateBtn.addEventListener('click', async () => {
        ...
        resultArea.textContent = 'AIが正規表現を生成しています...';
        generateBtn.disabled = true;

        try {
            const prompt = `以下の説明に基づいて、JavaScriptで利用できる正規表現を生成してください。正規表現のみを出力し、説明やコードブロックは含めないでください。\n\n説明: ${description}`;

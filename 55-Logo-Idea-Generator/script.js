document.addEventListener('DOMContentLoaded', () => {
    ...
    generateBtn.addEventListener('click', async () => {
        ...
        resultArea.textContent = 'AIがロゴのアイデアを生成しています...';
        generateBtn.disabled = true;

        try {
            const prompt = `以下のブランド名とコンセプトに基づいて、ロゴのアイデアを5つ提案してください。\n\nブランド名: ${brandName}\nコンセプト: ${concept}\n\n提案するアイデアは、具体的なデザインの方向性やモチーフを含めて記述してください。`;
